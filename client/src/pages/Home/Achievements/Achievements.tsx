    ...
    <div className="achievements">
      <div className="left-top-container achievements-subcontainer">
        <div className="achievement meals">
          ...
          <h3 className="description"><span>Meals</span> and <span>drinks</span> prepared and distributed</h3>
        </div>
        <div className="achievement shoes">
          <h2 className="number">500 +</h2>
          <h3 className="description"><span>Shoes</span> and <span>boots</span> purchased and given out</h3>
        </div>
      </div>
      <div className="right-bottom-container achievements-subcontainer">
        ...
        <div className="achievement sleeping-bags">
          ...
          <h3 className="description"><span>Sleeping bags</span> and <span>blankets</span> donated</h3>
        </div>
        <div className="achievement toiletries">
          <h2 className="number">300 +</h2>
          <h3 className="description"><span>Toiletries</span> prepared, packaged, and handed out</h3>
        </div>
      </div>
    </div>
  );
